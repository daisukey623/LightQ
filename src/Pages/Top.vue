    ...
    <div class="container mt-6">
      ...
      <div class="columns mt-6 mr-4 ml-4">
        <div class="column">
          ...
          <p class="has-text-left">
            疑問が解決されたタイミングで、振り返りましょう。
          </p>
          <p class="has-text-left mt-4">
            右肩上がりの直線的な成長ではなく、上がり下がりある日々の変化を記録することで、客観的に変化を理解できます。客観的に変化を確認することで、継続的に業務に取り込む援助になります。
          </p>
          <p class="has-text-left mt-4">
          変化に気づき、ゆるやかな成長に期待しましょう。
          </p>
        </div>
        <div class="column">
      ...
      <div class="columns mt-6 mr-4 ml-4">
        ...
        <div class="column">
          <H3>{{ able04.title }}</H3>
          <p class="has-text-left">
            他の人事担当者の業務の疑問にコメントすると、自動でその人事担当者をフォローします。あなたがフォローした人事担当者の日々の振り返りによる変化、そして成長を見守ることができます。
          </p>

          <p class="has-text-left mt-4">
            フォローした担当者の投稿も確認するができるので、もし力に慣れそうであれば継続してコメントによる支援することもできます。
          </p>
        </div>
      </div>
    </div>
